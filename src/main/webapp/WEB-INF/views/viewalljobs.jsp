...
<%@ page import="com.raj.JobApp.model.JobPost" %>
<%@ page import="com.raj.JobApp.repo.JobRepo" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="https://www.instagram.com/raz_negi/">Contact</a></li>
            </ul>
        </div>
    </div>
</nav>
